        ...
        <form class="layui-form" name="form" action="${ctx}/user/save">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" style="width: 30%">
                    <input type="text" name="username" value="${user.username}" <c:if test="${isEdit eq 'Y'}">readonly</c:if> lay-verType="tips"  lay-verify="required" placeholder="请输入用户名" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">昵称</label>
                <div class="layui-input-block"style="width: 30%">
                    <input type="text" name="nickname" value="${user.nickname}" <c:if test="${isEdit eq 'Y'}">readonly</c:if> lay-verType="tips"  lay-verify="required" placeholder="请输入昵称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">密码</label>
                <div class="layui-input-block"style="width: 30%">
                    <input type="password" name="pwd" value="${user.pwd}" <c:if test="${isEdit eq 'Y'}">readonly</c:if> lay-verType="tips"  lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
